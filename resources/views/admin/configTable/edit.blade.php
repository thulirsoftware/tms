...
@section('content')
   <div class="row">
      <div class="col-lg-12">
         <h1 class="page-header">Modify {{$tableName}} Record</h1>
      </div>
      <!-- /.col-lg-12 -->
   </div>
   <!-- /.row -->
      ...
      <div class="col-md-12">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               {!! Form::model($tableRow, [
      'method' => 'POST',
      'url' => ["/Admin/ConfigTable/" . base64_encode($tableName) . "/$tableRow->id/update"],
                     ...
                     <tbody>
                        @foreach($tableColumns as $key => $column)
                           <tr>
                              ...
                              <td colspan="2"><input class="form-control" type="text" name="{{$column}}" value="
                                  {{$tableRow->$column}}"></td>
                           </tr>
