...
<div class="row">
    ...
    <!-- /.col-lg-12 -->
                            ...
                            $send_date = Session::get('send_date');
...
<div class="row">
        ...
        <div class="form-group">
            ...
            <select id="receiverId" name="senderId" class="form-control">
                              ...
                              @foreach ($employees as $employees)
                                  ...
                                  <option value="{{ $employees->id }}" {{ $employees->id == $senderId ? 'selected' : ''}}>{{ $employees->name }}</option>
                              @endforeach
                          </select>
      </div>
    </div>
    ...
    margin-top: 36%;" href="/Admin/Link/reset"><i class="fa fa-refresh" aria-hidden="true" ></i></a>
    </div>
     <div class="col-md-1">
         <a  class="btn btn-info btn-rounded" href="/Admin/Link/add" style="
...
<div id="linksFilteration">
  @include('admin.links.components.getData')
</div>
