...
@section('content')
   <div class="row">
      <div class="col-lg-12">
         <h1 class="page-header">Add New Intern</h1>
      </div>
      <!-- /.col-lg-12 -->
   </div>
   <!-- /.row -->
   <div class="row">
      ...
      'files' => true
               ...
               <!-- Hidden input field to set the type as 'intern' -->
               {!! Form::hidden('type', 'intern') !!}
               <div class="col-md-12 split">
                  <div class="col-md-6 split">
               ...
               <div class="col-md-12 split">
                  <div class="col-md-6 split">
                     <div class="form-group {{ $errors->has('expLevel') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-5">
                           {!! Form::select('expLevel', ['2' => 'Intern'], null, ['class' => 'form-control', 'id' => 'expLevel']) !!}
                           {!! $errors->first('expLevel', '<p class="help-block">:message</p>') !!}
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-md-6 split">
                     <div class="form-group {{ $errors->has('expYear') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-4">
                           {!! Form::text('expYear', null, ['class' => 'form-control', 'placeholder' => "Years", 'id' => 'expYear']) !!}
                           {!! $errors->first('expYear', '<p class="help-block">:message</p>') !!}
                        </div>
                        <div class="form-group col-md-4 {{ $errors->has('expMonth') ? 'has-error' : ''}}">
                           {!! Form::text('expMonth', null, ['class' => 'form-control', 'placeholder' => "Months", 'id' => 'expMonth']) !!}
                           {!! $errors->first('expMonth', '<p class="help-block">:message</p>') !!}
                        </div>
                     </div>
                  </div>
               </div>
   ...
   <script>
      $(document).ready(function () {
         function toggleExperienceFields() {
            ...
            if (expLevel == '2') { // Intern
               $('#expYear, #expMonth').prop('disabled', true).val('');
            } else {
               $('#expYear, #expMonth').prop('disabled', false);
            }
         }
