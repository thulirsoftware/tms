...
@section('content')
    ...
    @php
        $default_nav = $default_nav ?? 'employees';
    @endphp

    <ul class="nav nav-pills mt-5">
        <li class="@if($default_nav == 'employees') active @endif"><a data-toggle="pill" href="#employees">Employees</a>
        </li>
                ...
                <tbody>
                    @foreach($employees as $employee)
                        <tr>
                            ...
                            <td
                                onclick="window.location.href='{{ route('admin.employee.edit', ['employee' => $employee->id]) }}'">
