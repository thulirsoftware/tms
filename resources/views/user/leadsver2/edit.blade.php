                    ...
                    <div class="col-md-6 form-group">
                     ...
                     <div class="col-md-6 form-group">
                      <label>Date&nbsp;<span style="color:red">*</span> </label>
                        <input type="text" name="date" class="form-control"  value="{{$lead->date}}" required>
                    </div>
                     <div class="col-md-6 form-group">
                      <label>District&nbsp;<span style="color:red">*</span> </label>
                        <input type="text" name="district" class="form-control"  value="{{$lead->district}}" required >
                    </div>
                     <div class="col-md-6 form-group">
                      <label>Approach For </label>
                        <input type="text" name="approach_status" class="form-control"  value="{{$lead->approach_status}}"   >
                    </div>
