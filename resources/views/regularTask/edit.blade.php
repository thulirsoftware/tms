      ...
      <div class="col-md-12">
         <div class="panel panel-default">
            ...
            <div class="panel-body">
               ...
               {!! Form::model($task, [
      'method' => 'POST',
      'url' => ["/RegularTask/$task->id/update"],
      ...
      Carbon\Carbon::today()->format('Y-m-d')
                  ...
                  <div class="col-md-3">
                     <div class="form-group {{ $errors->has('empId') ? 'has-error' : ''}}">
                        ...
                        {!! Form::select('empId', $employees, null, ['class' => 'form-control', 'required' => true, 'placeholder' => "Choose One", 'id' => 'empId']) !!}
                        {!! $errors->first('empId', '
                           <p class="help-block">:message</p>
                           ') !!}
                     </div>
                  ...
                  <div class="col-md-1"></div>
                  <div class="col-md-2">
                     <div class="form-group {{ $errors->has('taskType') ? 'has-error' : ''}}">
                        {!! Form::label('taskType', 'Task Type `*`', ['class' => 'control-label']) !!}
                        {!! Form::select('taskType', $taskTypes, null, ['class' => 'form-control', 'required' => true, 'placeholder' => "Choose One", 'id' => 'taskType']) !!}
                        {!! $errors->first('taskType', '
                           <p class="help-block">:message</p>
                           ') !!}
                     </div>
                  </div>
               ...
               <div class="col-md-8 col-md-offset-2">
                  <a href="{{Auth::user()->type == 'admin' || Auth::user()->hasPermission('Tasks') ? url('/Admin/Task') : url('/Task')}}"
