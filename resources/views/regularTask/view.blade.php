...
@section('content')
    <div class="row">
            ...
            <h3>Assigned / Pending Tasks
                <div style="float: right;">
                    @if(Auth::user()->type != 'admin')
                        ...
                        <a id="startBreak" onclick="setInterrupt('meeting')" class="btn btn-info btn-rounded"><i
        ...
        <div class="col-lg-12 well">
            ...
            @else
                <h3 class="page-header" style="text-align: center;">Currently Not Taking Any Tasks</h3>
            @endif
        </div>
    ...
    $sumMinutes = 0;?>
        ...
        <script type="text/javascript">
            ...
            function startTime(taskId) {
                ...
                var $taskComment = $("#taskComment_" + taskId);
                var $taskStatus = $("#taskStatus_" + taskId);

                // Hide old errors
                $taskComment.next("span.alert-danger").hide();
                $taskStatus.next("span.alert-danger").hide();
                ...
                if (!valid) {
                    return false; // ❌ stop execution, no AJAX
                }
